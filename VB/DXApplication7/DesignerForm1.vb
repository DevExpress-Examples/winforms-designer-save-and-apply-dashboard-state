...
Namespace WinDesignerDashboardState
	Partial Public Class DesignerForm1
        ...
        End Sub
        Private Sub dashboardDesigner_DashboardLoaded(ByVal sender As Object,
                ByVal e As DevExpress.DashboardWin.DashboardLoadedEventArgs) _
                Handles dashboardDesigner.DashboardLoaded
            ...
            End If
        End Sub
        Private Sub dashboardDesigner_SetInitialDashboardState(ByVal sender As Object,
                ByVal e As DevExpress.DashboardWin.SetInitialDashboardStateEventArgs) _
                Handles dashboardDesigner.SetInitialDashboardState
            e.InitialState = dState
        End Sub

        Private Sub DashboardDesigner_DashboardClosing(sender As Object,
                e As DevExpress.DashboardWin.DashboardClosingEventArgs) _
                Handles dashboardDesigner.DashboardClosing
            dState = dashboardDesigner.GetDashboardState()
            Dim userData As New XElement("Root", New XElement("DateModified", DateTime.Now),
